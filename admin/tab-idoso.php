...
<main class="w-full h-full p-10">
    <div class="flex flex-col md:flex-row md:justify-between md:items-center w-full max-w-5xl mx-auto mb-5 gap-4">
        ...
        <div class="flex items-center justify-center gap-3">
            ...
            <a href="form-add-idoso.php" class="text-white bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-md px-6 py-3 text-center dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">
                <i class="fas fa-plus"></i>
            </a>

            <button data-modal-target="search-idoso" data-modal-toggle="search-idoso" class="text-white bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-md md:text-md px-4 md:px-6 py-3 transition">
                <i class="fas fa-search"></i>
            </button>

            <a href="servicos.php" class="text-center text-xl w-28 p-2 rounded-xl bg-yellow-600 text-white hover:bg-yellow-500 duration-75">
                Voltar
            </a>
        </div>
    </div>
