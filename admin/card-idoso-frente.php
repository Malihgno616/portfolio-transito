...
<main class="w-full h-full p-10">
    ...
    <iframe src="cartao-idoso/cartao-idoso-id120-frente.pdf" width="100%" height="600px"></iframe>
    <a class="flex justify-center text-xl text-center m-7 hover:underline" href="cartao-idoso/cartao-idoso-id120-frente.pdf" download>Clique aqui para baixar o arquivo</a>
