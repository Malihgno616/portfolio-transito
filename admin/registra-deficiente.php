...
$idBeneficiario = $inputPost['id-beneficiario'];

$numRegistro = $inputPost['numero-registro-deficiente'];
...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if($updated) {
        ...
        $_SESSION['alert-beneficiario'] = setAlert("Erro ao adicionar nº de registro do deficiente.", 'error');
    }
    ...
    exit;
        ...
        $_SESSION['alert-beneficiario'] = setAlert("Erro ao adicionar nº de registro do deficiente: " . $e->getMessage(), 'error');
        header("Location: tab-deficiente.php");
        exit;
    }
}