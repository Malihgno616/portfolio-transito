...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $deleted = $contactModel->deleteAllContacts();

    if($deleted) {
        $_SESSION['success_del_contact'] = setAlert("Todos os contatos foram deletados com sucesso!", "success");
        header('Location: contatos.php');
        exit();
    } else {
        $_SESSION['error_message'] = setAlert("Erro ao deletar contatos!", "error");
        header('Location: contatos.php');
        exit();
    }
}
