...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $deleted = $formIdosoModel->deleteAllFormIdoso();

    if($deleted) {
        $_SESSION['idoso-alert'] = setAlert("Todos os formulários de idosos foram deletados com sucesso!", "success");
        header('Location: tab-idoso.php');
        exit();
    } else {
        $_SESSION['idoso-alert'] = setAlert("Erro ao deletar formulários de idosos!", "error");
        header('Location: tab-idoso.php');
        exit();
    }
}