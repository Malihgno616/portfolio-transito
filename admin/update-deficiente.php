...
$updateRgBeneficiario = false;
$updateAtestado = false;
$updateRgRep = false;
$updateCompRep = false;

$idBeneficiario = $inputPost['id-benef'];
...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if($updated) {
        $_SESSION['alert-beneficiario'] = setAlert('Beneficiário atualizado com sucesso!', 'success');
    } else {
        $_SESSION['alert-beneficiario'] = setAlert('Erro ao atualizar o beneficiário. Tente novamente.', 'error');
    }
