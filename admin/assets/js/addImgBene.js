document.addEventListener('DOMContentLoaded', function() {
    const fileInput = document.getElementById('dropzone-rg-bene');
    const defaultContent = document.getElementById('default-content-bene');
    const previewContent = document.getElementById('preview-content-bene');
    const previewContainer = document.getElementById('rg-bene-image-preview');
    const fileNameDisplay = document.getElementById('rg-bene-file-name');
    const nameInput = document.getElementById('nome-aqv-rg-bene');
        ...
        if (file) {
            ...
            if (file.type === 'application/pdf') {
                ...
                reader.onload = function(e) {
                    ...
                    img.alt = "Imagem do RG do Beneficiário";
