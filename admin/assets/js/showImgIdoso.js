document.addEventListener('DOMContentLoaded', function() {
    const fileInput = document.getElementById('dropzone-rg-idoso');
    const defaultContent = document.getElementById('default-content');
    const previewContent = document.getElementById('preview-content');
    const previewContainer = document.getElementById('rg-idoso-image-preview');
    const fileNameDisplay = document.getElementById('rg-idoso-file-name');
    const nameInput = document.getElementById('nome-aqv-rg-idoso');
