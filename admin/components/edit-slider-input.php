...
<div class="p-10 m-10 rounded-xl">
    ...
    <div class="mb-8 p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow duration-300">
        ...
        <form action="#" method="post" class="space-y-4">
            <img src="../assets/img/img-slider7.jpg" alt="Slider Numero Whatsapp" class="w-full h-94 object-cover mb-4 border border-gray-300 bg-gray-100">
            
            <input class="cursor-pointer bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand block w-full shadow-xs placeholder:text-body" id="edit-slider-1" name="slider-1" type="file">
    ...
    <div class="mb-8 p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow duration-300">
        ...
        <form action="#" method="post" class="space-y-4">
            <img src="../assets/img/img-slider8.jpg" alt="Slider Indicação Condutor" class="w-full h-94 object-cover mb-4 border border-gray-300 bg-gray-100">
    ...
    <div class="mb-8 p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow duration-300">
        ...
        <form action="#" method="post" class="space-y-4">
            <img src="../assets/img/img-slider9.jpg" alt="Slider Vagas Especiais" class="w-full h-94 object-cover mb-4 border border-gray-300 bg-gray-100">
