...
<div class="animate__animated animate__fadeIn p-10 m-10 rounded-xl">
    ...
    <div class="mb-8 p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow duration-300">
        ...
        <form id="edit-slider-1" action="#" method="post" enctype="multipart/form-data" class="space-y-4">
    ...
    <div class="mb-8 p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow duration-300">
        ...
        <form id="edit-slider-2" action="#" method="post" enctype="multipart/form-data" class="space-y-4">
