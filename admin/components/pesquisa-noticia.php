<form class="w-full max-w-6xl mx-auto m-10 flex flex-col gap-6">   
    ...
    <div class="relative">
        ...
        <input type="search" id="input-main-title"
    ...
    <div class="relative">
        ...
        <input type="search" id="input-main-subtitle"
        placeholder="Pesquisar pelo Sub-Título"
        class="text-lg block w-full p-3 ps-9 bg-neutral-secondary-medium border border-gray-200 text-heading rounded-lg focus:ring-yellow-400 focus:border-yellow-600 shadow-xs placeholder:text-body" />
    </div>   
    ...
    <div class="relative">
        ...
        <input type="search" id="input-content-text"
        placeholder="Pesquisar pelo Texto do Conteúdo"
        class="text-lg block w-full p-3 ps-9 bg-neutral-secondary-medium border border-gray-200 text-heading rounded-lg focus:ring-yellow-400 focus:border-yellow-600 shadow-xs placeholder:text-body" />
    </div>
