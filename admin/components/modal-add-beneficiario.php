...
<div id="add-beneficiario-modal" tabindex="-1" class="animate__animated animate__fadeInDown fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            ...
            <div class="p-4 md:p-5 space-y-4">
                    <form id="form-add-beneficiario" action="add-deficiente.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="p-5 grid grid-cols-3 gap-10">
                            ...
                            <div class="relative z-0">
                                <input type="text" class="block py-2.5 px-0 w-full text-md text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-yellow-500 peer" placeholder=" " name="num-identidade-beneficiario" oninput="formatDoc(this)">
                                    <label for="" class="absolute text-md text-gray-500 duration-300 transform -translate-y-6 scale-100 top-3 -z-10 origin-[0] 
                                    peer-focus:start-0 peer-focus:text-yellow-500 
                                    peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-1 
                                    peer-focus:scale-90 peer-focus:-translate-y-6">
                            ...
                            <div class="relative z-0">
                                <input type="text" class="block py-2.5 px-0 w-full text-md text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-yellow-500 peer" placeholder=" " name="data-exp-beneficiario" oninput="formatDate(this)">
                                    <label for="" class="absolute text-md text-gray-500 duration-300 transform -translate-y-6 scale-100 top-3 -z-10 origin-[0] 
                                    peer-focus:start-0 peer-focus:text-yellow-500 
                                    peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-1 
                                    peer-focus:scale-90 peer-focus:-translate-y-6">
                        ...
                        <h1 class="text-center text-2xl p-5">Cópia do RG do Beneficiário</h1>
                        ...
                        <div class="relative z-0">
                            <div class="flex items-center justify-center w-full">
                                <label for="dropzone-rg-bene" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-200 dark:bg-gray-100 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-200 dark:hover:bg-gray-200">
                                    ...
                                    <input id="dropzone-rg-bene" type="file" class="hidden" name="copia-rg-beneficiario" accept=".png,.jpg,.jpeg,.pdf"/>
                                    <input type="hidden" name="nome-aqv-rg-bene" id="nome-aqv-rg-bene">
                                </label>
                            </div>
                        </div>

                        <h1 class="text-center text-2xl p-5">Informações do médico</h1>
                        ...
                        <div class="p-5 grid grid-cols-2 gap-10">
                            ...
                            <div class="relative z-0">
                                <input type="text" class="block py-2.5 px-0 w-full text-md text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-yellow-500 peer" placeholder=" " name="telefone-medico" oninput="formatPhone(this)">
                                    <label for="" class="absolute text-md text-gray-500 duration-300 transform -translate-y-6 scale-100 top-3 -z-10 origin-[0] 
                                    peer-focus:start-0 peer-focus:text-yellow-500 
                                    peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-1 
                                    peer-focus:scale-90 peer-focus:-translate-y-6">
                        ...
                        <p class="text-justify text-lg p-5">Assinalar o tempo. Em sentido <strong>temporário</strong>, informar o período previsto de restrição médica. No mínimo 2 meses e no máximo 1 ano.</p>
                        ...
                        <p class="text-justify text-lg m-5 p-5">Descricao e CID da lesão que justifique a incapacidade ou dificuldade ambular</p>
                        ...
                        <h1 class="text-center text-2xl p-5">Cópia do atestado médico</h1>
                        ...
                        <div class="p-5 grid grid-cols-3 gap-10">
                            ...
                            <div class="relative z-0">
                                <input type="text" class="block py-2.5 px-0 w-full text-md text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-yellow-500 peer" placeholder=" " name="num-identidade-rep" oninput="formatDoc(this)">
                                    <label for="" class="absolute text-md text-gray-500 duration-300 transform -translate-y-6 scale-100 top-3 -z-10 origin-[0] 
                                    peer-focus:start-0 peer-focus:text-yellow-500 
                                    peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-1 
                                    peer-focus:scale-90 peer-focus:-translate-y-6">
                    ...
                    document.addEventListener('DOMContentLoaded', () => {
                        const form = document.getElementById("form-add-beneficiario");
                        ...
                        <div class="w-50 gap-5 m-10 flex items-center justify-center">
                            <button type="submit" id="submit-btn" class="flex items-center justify-center text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-md px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                                <span id="btn-text" class="mr-2">Registrar beneficiário</span> 
