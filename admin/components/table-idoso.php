    ...
    <form class="max-w-4xl mx-auto m-10">   
        ...
        <div class="relative">
            ...
            <input type="search" id="search" class="block w-full p-3 ps-9 bg-neutral-secondary-medium border border-gray-200 text-heading text-sm rounded-lg focus:ring-yellow-400 focus:border-yellow-600 shadow-xs placeholder:text-body" placeholder="Digite informações do idoso para filtrar (RG, Nº do cartão, Nome, ou Data de nascimento no formato dd/mm/aaaa)" required />
                            ...
                            <tr class="bg-white border-b hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-lg flex gap-5">
                                        ...
                                        <form action="detalhes-card-idoso.php" method="get">
                                            ...
                                            <button type="submit" class="font-medium rounded-lg p-1 bg-blue-100 text-blue-600 dark:text-blue-500 hover:bg-blue-200"><i class="fa-solid fa-pen-ruler"></i>
                                            </button>
                                        </form>
                                        ...
                                        <button data-modal-target="register-num-idoso-<?= $idoso['id']?>" data-modal-toggle="register-num-idoso-<?= $idoso['id']?>" class="font-medium rounded-lg p-1 bg-yellow-100 text-yellow-700 dark:text-yellow-700 hover:bg-yellow-200">Registrar</button>
