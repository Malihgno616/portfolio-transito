      ...
      <?php if(!empty($mainNewsData) && !empty($contentNewsData)): ?>         
          ...
          <div class="relative z-0">
              <div class="flex items-center justify-center w-full">
                  ...
                  <div class="flex flex-col items-center justify-center pt-5 pb-6">
                      <div id="main-image-preview" class="mt-4 flex justify-center">
                        <?php if(isset($mainNewsData) && $mainNewsData['img_noticia']): ?>
                          <div class="mb-6 w-full">
                            <h2 class="text-xl font-bold mb-2 text-center">Pré-visualização da Imagem Principal</h2>
                            <div class="flex justify-center">
                              <img src="display-image.php?id=<?= $mainNewsData['id_noticia'] ?>&type=main" 
                                  alt="img noticia"
              ...
              <div class="flex items-center justify-center w-full mt-4">
                <input type="text" name="name-img-file-main" value="<?= $mainNewsData['nome_img_noticia']?>" class="border-2 border-gray-300 text-center rounded-lg w-full" readonly/>
              </div>
          </div>
          ...
          <div class="relative z-0">
              ...
              <label for="dropzone-file-content-news" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                  <div id="image-preview-content" class="mt-4 flex justify-center">
                    <?php if(isset($contentNewsData) && $contentNewsData['img_conteudo']): ?>
                      <div class="mb-6 w-full">
                        <h2 class="text-xl font-bold mb-2 text-center">Pré-visualização da Imagem de Conteúdo</h2>
                        <div class="flex justify-center">
                          <img src="display-image.php?id=<?= $contentNewsData['id_conteudo'] ?>&type=content" 
                              alt="img conteudo"
                              class="max-w-full max-h-40 object-contain rounded-lg">
                        </div>
                      </div>
            ...
            <div class="flex items-center justify-center w-full mt-4">
              <input type="text" name="name-img-file-content" value="<?= $contentNewsData['nome_img_conteudo']?>" class="border-2 border-gray-300 text-center rounded-lg w-full" readonly/>
            </div>
          </div>
          ...
          <button type="submit" class="text-center text-xl w-full p-2 rounded-md bg-green-600 text-white hover:bg-green-500 duration-75">Salvar Alterações</button>
      <?php endif;?>
    </form>
</div>