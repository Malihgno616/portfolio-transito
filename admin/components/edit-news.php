<form action="#" method="post" class="border-2 border-gray-200 rounded-lg p-4 m-4" enctype="multipart/form-data">
  <input type="hidden" name="conteudo" value="<?= $newsModel->getNewsById($id)['id'] ?>">
