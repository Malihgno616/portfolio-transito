        ...
        <div class="relative bg-white border border-default rounded-lg shadow-sm p-4 md:p-6">            
            <div class="flex items-center justify-between border-b border-default pb-4 md:pb-5">
                <h3 class="text-lg font-medium text-heading">
                    Digite informações do idoso para filtrar (RG, Nº do cartão, Nome, ou Data de nascimento no formato dd/mm/aaaa)
                </h3>
            ...
            <form class="max-w-4xl mx-auto m-14">   
                ...
                <div class="relative">
                    ...
                    <input type="search" id="search" class="block w-full p-3 ps-9 bg-neutral-secondary-medium border border-gray-200 text-heading text-lg rounded-lg focus:ring-yellow-400 focus:border-yellow-600 shadow-xs placeholder:text-body"/>
                </div>
            </form>
        </div>
    </div>
