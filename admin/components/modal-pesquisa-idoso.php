        ...
        <div class="relative bg-white border border-default rounded-lg shadow-sm p-4 md:p-6">            
            <div class="flex items-center justify-between border-b border-default pb-4 md:pb-5">
                <h3 class="text-lg font-medium text-heading">
                    Digite informações do idoso para filtrar (ID, Nome, RG, Nº de Registro ou Telefone)
                </h3>
            ...
            <form class="w-full max-w-6xl mx-auto m-10 flex flex-col gap-6">   
                ...
                <div class="relative">
                    ...
                    <input type="search" id="input-rg-idoso"
                ...
                <div class="relative">
                    ...
                    <input type="search" id="input-phone-idoso"
