...
<div class="relative overflow-x-auto border border-gray-200 max-w-xl p-4 mx-auto rounded-lg">
    <table class="m-auto text-sm text-left rtl:text-right text-gray-500 dark:text-gray-800">
    <thead class="text-lg text-gray-700 uppercase bg-gray-50 dark:text-gray-400">
        ...
        <tr class="bg-white border-b hover:bg-gray-50">
            ...
            <td class="px-6 py-4 flex gap-2 text-lg">
                <button type="button" data-modal-target="edit-user-<?= $user['id'] ?>" data-modal-toggle="edit-user-<?= $user['id'] ?>" class="font-medium rounded-lg p-1 bg-yellow-100 text-yellow-600 dark:text-yellow-500 hover:bg-yellow-200"><i class="fa-solid fa-pen-ruler"></i></button>
                ...
                <button type="submit" class="font-medium rounded-lg p-1 bg-red-100 text-red-600 dark:text-red-500 hover:bg-red-200"><i class="fa-solid fa-trash"></i></button>
                </form>
            </td>
        </tr>
        <?php endforeach; ?>
