<div class="p-4 md:p-5 space-y-4">
    <form id="form-add-idoso" action="add-idoso.php" method="post" enctype="multipart/form-data" class="border-2 border-gray-200 p-12 rounded-xl">
        <div class="p-5 grid grid-cols-3 gap-10">
            ...
            <div class="relative z-0">
                <input type="text" class="block py-2.5 px-0 w-full text-md text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-yellow-500 peer" placeholder=" " name="num-identidade-idoso" oninput="formatDoc(this)">
                    <label for="" class="absolute text-md text-gray-500 duration-300 transform -translate-y-6 scale-100 top-3 -z-10 origin-[0] 
                    peer-focus:start-0 peer-focus:text-yellow-500 
                    peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-1 
                    peer-focus:scale-90 peer-focus:-translate-y-6">
