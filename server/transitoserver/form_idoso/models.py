...
# Enum para estados, pode ser reutilizado por ambos os modelos
...
class SeniorForm(models.Model):
    ...
    zip_code = models.CharField(max_length=9, verbose_name='CEP')  # Alterado para CharField
    ...
    phone = models.CharField(max_length=20, verbose_name='Telefone')  # Alterado para CharField
    ...
    rg_copy_doc = models.FileField(upload_to='rg_docs/', verbose_name='Cópia do RG')
...
class LegalRepresentative(models.Model):
    ...
    rg_copy_doc = models.FileField(upload_to='rg_docs/', verbose_name='Cópia do RG')
    representative_doc = models.FileField(upload_to='representative_docs/', verbose_name='Documento do Representante')
