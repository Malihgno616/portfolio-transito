...
if(mysqli_num_rows($result) > 0){
  ...
  $query = "INSERT INTO segunda_via_cartao_deficiente_roubo(rg_beneficiario, boletim_ocorrencia) values(?,?)";
  ...
  if($executed) {
    $mensagem = "Solicitação para segunda via enviada com sucesso!";
  } else {
