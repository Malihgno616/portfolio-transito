<main class="texto-format animate__animated animate__fadeIn mx-auto p-5 sm:p-10">
  ...
  <h1 class="text-4xl sm:text-5xl p-5">Sinalizações</h1>
  <p class="text-justify text-lg sm:text-xl p-5">Nesta página estão relacionadas as solicitações de sinalizações (placas de regulamentação e/ou advertências, entre outras).</p>
