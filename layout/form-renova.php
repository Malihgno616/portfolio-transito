...
<form action="config/database/verify-renova-cartao-db.php" method="post"
  ...
  <?php 
    if(isset($_SESSION['renova-alert'])) {
      echo $_SESSION['renova-alert'];
      unset($_SESSION['renova-alert']);
    }
  ?>
  ...
  <div class="relative mb-5">
    ...
    <label for=""
      class="absolute text-sm text-gray-500 peer-focus:text-yellow-500 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white px-2 peer-focus:px-2 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1">RG/CPF do beneficiário
    </label>
  </div>
