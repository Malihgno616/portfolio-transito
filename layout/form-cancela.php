<div class="container">
  ...
  <form action=".././config/database/cancela-cartao-db.php" method="post" class="form">
      <div class="title">
        ...
        <p>
        Informe abaixo o motivo do cancelamento e as informações necessarias. 
        </p>
        <p>
          Se possivel, entregue seu cartão na secretaria para concluir o cancelamento. 
        </p>
      </div>
      ...
      <div class="input-group">
          <input type="text" name="num-cartao" class="input" required>
