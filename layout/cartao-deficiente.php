...
<form action="<?=$_SERVER['PHP_SELF']?>" method="post" class="space-y-6 animate__animated animate__fadeIn mt-8 mb-8 w-100 m-auto p-10 rounded-lg shadow-md">
  <h2 class="text-xl font-semibold">Selecione o tipo de solicitação</h2>

  <div class="space-y-4">
    <!-- Adicione required em todos os radio buttons -->
    <div class="flex items-center">
      <input id="cartao1" type="radio" name="solicitacao" value="1" class="w-4 h-4 text-yellow-500 bg-gray-100 border-gray-300 focus:ring-yellow-500" required>
      <label for="cartao1" class="ml-2 text-md font-medium text-gray-900">Desejo fazer meu 1º cartão</label>
    </div>

    <div class="flex items-center">
      <input id="cartao2" type="radio" name="solicitacao" value="2" class="w-4 h-4 text-yellow-500 bg-gray-100 border-gray-300 focus:ring-yellow-500" required>
      <label for="cartao2" class="ml-2 text-md font-medium text-gray-900">Desejo renovar meu cartão</label>
    </div>

    <div class="flex items-center">
      <input id="cartao3" type="radio" name="solicitacao" value="3" class="w-4 h-4 text-yellow-500 bg-gray-100 border-gray-300 focus:ring-yellow-500" required>
      <label for="cartao3" class="ml-2 text-md font-medium text-gray-900">Desejo cancelar meu cartão</label>
    </div>

    <div class="flex items-center">
      <input id="cartao4" type="radio" name="solicitacao" value="4" class="w-4 h-4 text-yellow-500 bg-gray-100 border-gray-300 focus:ring-yellow-500" required>
  ...
  <div id="motivoContainer" class="mt-6 hidden">
    ...
    <select id="" name="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5">
