<main class="animate__animated animate__fadeIn mx-auto p-5 sm:p-10">
  ...
  <section class="mb-10">
    <p class="text-justify text-lg sm:text-xl p-5"> Caso não seja o infrator ou sendo o veículo de Pessoa Jurídica,
  ...
  <section class="mb-10">
    <p class="text-justify text-lg sm:text-xl p-5">Sendo o Proprietário do veículo pessoa jurídica e não havendo a
      identificação do Condutor/Infrator, será imposta outra multa, nos termos do §7º e §8º do Art. 257 do CTB,
      expedindo-se a notificação de penalidade desta ao proprietário do veículo (Artigo 4º da Resolução CONTRAN nº
