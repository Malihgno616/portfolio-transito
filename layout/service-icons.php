<main class="m-5 flex flex-col justify-center items-center">
  ...
  <div class="servicos animate__animated animate__fadeIn p-10 mx-auto">
    ...
    <ul class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
      <!-- Item de Serviço -->
      <li
        class="flex flex-col items-center border-2 border-black rounded-full p-4 hover:border-yellow-500 transition duration-300">
        <a class="text-base sm:text-xl text-black p-4 flex flex-col items-center justify-center hover:text-gray-500 duration-200"
      ...
      <li
        class="flex flex-col items-center border-2 border-black rounded-full p-4 hover:border-yellow-500 transition duration-300">
        <a class="text-base sm:text-xl p-4 flex flex-col items-center justify-center hover:text-gray-500 duration-200"
